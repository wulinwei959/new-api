...
func (b *atomicBucket) add(sample Sample) {
	...
	if sample.IsServerError {
		b.serverErrorCount.Add(1)
	}
...
func (b *atomicBucket) snapshot() counters {
	return counters{
		...
		serverErrorCount: b.serverErrorCount.Load(),
...
func (b *atomicBucket) drain() counters {
	return counters{
		...
		serverErrorCount: b.serverErrorCount.Swap(0),
...
func (b *atomicBucket) addCounters(c counters) {
	...
	if c.serverErrorCount != 0 {
		b.serverErrorCount.Add(c.serverErrorCount)
	}
