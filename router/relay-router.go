...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.ModelRateLimitByModel())
	{
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.ModelRateLimitByModel())
	...
	}
	{
		...
		httpRouter.Use(middleware.ModelRateLimitByModel())
	...
	relayGeminiRouter.Use(middleware.ModelRateLimitByModel())
	{
