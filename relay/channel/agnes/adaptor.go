...
// Agnes AI (agnes-ai.com / agnes-ai.cn) exposes an OpenAI-compatible gateway;
// one adaptor serves both the international and China channel types, which only
// differ in their default base URL.
type Adaptor struct {
	ChannelType int
}
